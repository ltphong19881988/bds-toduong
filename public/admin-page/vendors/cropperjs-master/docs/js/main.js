...
var initCroper = function(parentElement) {
    'use strict';
    ...
    actions.querySelector('.docs-buttons').onclick = function(event) {
        ...
        if (data.method) {
            ...
            switch (data.method) {
                ...
                case 'getCroppedCanvas':
                    if (result) {
                        console.log(result, parentElement.parent().find('img'));
                        // console.log(result.toDataURL(uploadedImageType))
                        parentElement.parent().find('img').attr('src', result.toDataURL(uploadedImageType));
                        jQuery('#cropImageModal').modal('hide');
                        // // Bootstrap's Modal
