...
var addImageToElement = function(_files, contentDiv, $scope, $compile) {
    var promise = [];
    _files.map(file => {
        promise.push(doAddImageToElement(file, contentDiv, $scope, $compile));
    })
...
adminApp.controller("categoryCtrl", function($rootScope, $scope, $compile, $http) {
    ...
    $scope.prepareAdd = function(e, item) {
    ...
    $scope.prepareEdit = function(e) {
        ...
        getCategoryInfo({ _id: jQuery(e.currentTarget).attr('idparent') }, $http, function(response) {
            ...
            jQuery("#formEditCategory input[name='oneLvlUrl']").val(response.postContent.oneLvlUrl);
            jQuery("#formEditCategory input[name='seoKeyWord']").val(response.postContent.seoKeyWord);
            jQuery("#formEditCategory input[name='seoDescriptions']").val(response.postContent.seoDescriptions);
